...
class FilterAdapter(
    ...
    private val filterList=listOf<String>(context.getString(R.string.Name),context.getString(R.string.Username),context.getString(R.string.Slack_Username), context.getString(R.string.Interests),context.getString(R.string.Bio),context.getString(R.string.Location),context.getString(R.string.Occupation),
            context.getString(R.string.Organization),context.getString(R.string.Skills),context.getString(R.string.Available_to_mentor),context.getString(R.string.Needs_mentoring))
    ...
    override fun onBindViewHolder(holder: FilterViewHolder, position: Int) {
         ...
         * */
        if (header!=context.getString(R.string.Available_to_mentor) && header!=context.getString(R.string.Needs_mentoring)) {
        ...
        itemView.setOnClickListener {
            ...
            if (itemView.cbFilter.isChecked){
                if (header==context.getString(R.string.Available_to_mentor) || header==context.getString(R.string.Needs_mentoring)) {
                    filtersApplied[header]=context.getString(R.string.True)
                }else{
