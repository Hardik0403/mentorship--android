    ...
    */
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        /**
         * onClickListener for the FloatingActionButton of Filters.
         * */
        fabAddFilter.setOnClickListener {
            /**
             * Starting the FilterActivity
             * */
        ...
        if (requestCode==REQUEST_CODE_FILTER_ACTIVITY && resultCode==RESULT_OK){
            ...
            if (filterStatus){
                ...
                val filteredList = membersViewModel.userList.filter {
                    ...
                    val filterNeedsMentoring = if (it.needsMentoring!=null && filtersApplied[context?.getString(R.string.Needs_mentoring)] != null) it.needsMentoring.toString()== filtersApplied[context?.getString(R.string.Needs_mentoring)] else false
